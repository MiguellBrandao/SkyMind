...
export async function resolveCommandTarget(interaction: ChatInputCommandInteraction): Promise<{ uuid: string; username: string }> {
  ...
  return { uuid: account.minecraftUuid, username: account.minecraftUsername };
}
